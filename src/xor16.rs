//! Implements an Xor16 Xor16 as described in [Xor Xor16s: Faster and Smaller Than Bloom and Cuckoo Xor16s].
//!
//! [Xor Xor16s: Faster and Smaller Than Bloom and Cuckoo Xor16s]: https://arxiv.org/abs/1912.08258
